...
/*SEND MAIL*/
/*define('CONS_HOST_SMTP_SERVER', 'mail.netspace.edu.vn');
define('CONS_SEND_MAIL_ACCOUNT', 'admin@netspace.edu.vn');
define('CONS_SEND_MAIL_PASSWORD', 'hieunhan#123*');
define('CONS_SEND_MAIL_FROM', 'admin@netspace.edu.vn');*/
...
define('CONS_SEND_MAIL_FROM', 'trannhan@iappscode.com');*/

/*define('CONS_HOST_SMTP_SERVER', 'smtp.gmail.com');
define('CONS_SEND_MAIL_ACCOUNT', 'no-reply@stevbros.com');
define('CONS_SEND_MAIL_PASSWORD', 'No-reply#123*');
define('CONS_SEND_MAIL_FROM', 'replyto@stevbros.com');*/
