...
echo $cF->displayDiv('Date lập', $data);
...
$data .= '<input type="button" value="Search" class="adBtnSmall bgColorBlue1 corner5 value_search" style="float:none; margin-left:5px" /> <p class="adError error value_name_error" style="margin-left:100px"></p>';
...
$(document).ready(function(e) {
	...
	$("#btnViewAddCustomer").click(function(){
		...
		$data .= $cF->inputButton($name, 'Search', 'adBtnSmall bgColorBlue1 corner5 value_search');
		$name = 'btnAddCustomer';
