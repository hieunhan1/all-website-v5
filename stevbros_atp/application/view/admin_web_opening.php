...
<div id="adContent">
	<div class="tagsHidden">
        <p class="fieldQuickView" type="txt" name="name">Khóa học</p>
        <p class="fieldQuickView" type="txt" name="opening">Khai giảng</p>
        <p class="fieldQuickView" type="txt" name="duration">Thời lượng</p>
    </div>
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="adTable">
    	<tr class="header">
        	<th width="50">No.</th>
            <th align="left">Name</th>
            <th width="150" align="left">Opening date</th>
