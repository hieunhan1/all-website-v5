...
<div id="wrapper">
    <div id="adTop">
        ...
        <div class="right">
            <span class="adIconWhite adIconUser"></span>Hello: <span class="b"><?php echo $_SESSION['adminName']; ?></span>
            <a href="<?php echo CONS_LINK_ADMIN;?>/user/?infomation=1" class="link"><span class="adIconWhite adIconPass"></span>Change password</a> | 
    ...
    <div id="adHeader">
        ...
        <div id="fastAction">
        	<p id="btnSave" class="corner5"><span class="adIconArticle adIconBlack"></span>Save</p>
            <p class="btnClose corner5"><span class="adIconBack adIconBlack"></span>Back</p>
        </div>
        <script type="text/javascript">
		$(document).ready(function(e) {
			...
			if( $(".adCreate").length ){
				var str = $(".adCreate").attr("href");
					str = '<p class="corner5"><a href="' + str + '" style="display:block; color:#333; text-decoration:none"><span class="adIconBack adIconBlack"></span>Add</a></p>';
				$("#fastAction").html(str);
				$("#fastAction").show();
			}
        });
    ...
    <div id="adRight">
		...
		if($roleCreate==1){
			...
			$btnCreate = '<a href="'.$link.'" class="adCreate iconLogin">Add</a>';
		}
		if($roleEdit==1){
...
<div id="popup">
	<div id="popupContent"><div class="process">Save thành công</div></div>
    <div id="popupBG"></div>
</div>
