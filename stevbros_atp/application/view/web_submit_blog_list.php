<div class="container">
    ...
    <div id="frm-submission" class="frm-loading">
        ...
        <div class="txt"><textarea name="description" class="field_item adInput" spellcheck="false" check="2" message="Vui lòng nhập mô tả ngắn" placeholder="Name ngắn"></textarea><p class="error"></p></div>
