...
$name = 'menu_id';
$where = "(type_id=1 OR type_id=3 OR type_id=4)";
...
$others = $cF->ckeditorStandard($name);
$data = $cF->textArea($name, $value, 'ad_field_second', $properties, $others);
echo $cF->displayDiv('Vị trí', $data);
...
$others = $cF->ckeditorStandard($name);
$data = $cF->textArea($name, $value, 'ad_field_second', $properties, $others);
echo $cF->displayDiv('Tiện ích', $data);
...
$others = $cF->ckeditorStandard($name);
$data = $cF->textArea($name, $value, 'ad_field_second', $properties, $others);
echo $cF->displayDiv('Mặt bằng', $data);
...
$others = $cF->ckeditorStandard($name);
$data = $cF->textArea($name, $value, 'ad_field_second', $properties, $others);
echo $cF->displayDiv('Giao dịch', $data);
