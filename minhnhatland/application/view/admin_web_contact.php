	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="adTable">
		...
		foreach($data as $row){
            ...
            <tr class="row">
                ...
                <td><?php echo $cons_contact_type[$row['type']]['name'];?></td>
