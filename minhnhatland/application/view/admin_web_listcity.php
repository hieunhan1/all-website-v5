...
<div id="adContent">
	<div class="tagsHidden">
        ...
        <p class="fieldQuickView" type="txt" name="deliverycosts">Phí giao hàng</p>
    </div>
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="adTable">
    	<tr class="header">
            ...
            <th width="150" align="left">Phí giao hàng</th>
		...
		$arr = array(
			'lang'=>$lang,
			'select'=>'`id`, `name`, `deliverycosts`, `_order`, `status`',
			'table'=>$table,
			//'where'=>'',
			'order'=>'`_order` DESC',
		);
		...
		foreach($data as $row){
            ...
            <tr class="row">
                ...
                <td><p class="height"><?php echo $row['id'];?></p></td>
                <td><p class="height"><?php echo $row['name'];?></p></td>
                <td><p class="height"><?php echo $row['deliverycosts'];?></p></td>
