...
<div id="adContent">
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="adTable">
    	<tr class="header">
            ...
            <th width="300" align="left">Giá trị</th>
		...
		$arr = array(
			'lang'=>$lang,
			'select'=>'`id`, `name`, `name_var`, `value`, `_order`, `status`',
			'table'=>$table,
			//'where'=>'',
			'order'=>'`_order`',
		);
		...
		foreach($data as $row){
            ...
            <tr class="row">
                ...
                <td><p class="height"><?php echo $row['name_var'];?></p></td>
                <td><p class="height"><?php echo $row['value'];?></p></td>
