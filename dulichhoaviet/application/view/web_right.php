...
echo '<div id="left" class="right-box">';
...
if(count($data) > 0){
	...
	foreach($data as $row){
		...
		echo '<div class="box margin-bottom" style="width:100%">
			<p class="img imgHeight2"><a href="'.$row['name_alias'].'"><img src="'.$img.'" alt="'.$row['name'].'" /></a></p>
