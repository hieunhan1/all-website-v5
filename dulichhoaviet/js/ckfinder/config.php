...
$config['LicenseName'] = '';
$config['LicenseKey'] = '';
$baseUrl = '/all_v5/stevbros_v2/public/';
...
$config['plugin_imageresize']['smallThumb'] = '250x350';
$config['plugin_imageresize']['mediumThumb'] = '300x400';
$config['plugin_imageresize']['largeThumb'] = '550x350';