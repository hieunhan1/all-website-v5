...
define('CONS_BASE_URL', 'http://www.bachyen.com.vn');
define('CONS_HOST', 'localhost');
define('CONS_USER_DB', 'bachyen');
define('CONS_PASS_DB', 'bachyen#123*');
define('CONS_NAME_DB', 'bachyen');
...
define('CONS_SEND_MAIL_FROM_NAME', 'Dược Phẩm Bạch Yến');
...
$cons_contact_type = array();
$cons_contact_type[] = array('id'=>'', 'name'=>'-- chọn loại --');
$cons_contact_type[] = array('id'=>1, 'name'=>'Liên hệ');
$cons_contact_type[] = array('id'=>2, 'name'=>'Đăng ký học');
$cons_contact_type[] = array('id'=>3, 'name'=>'Tuyển dụng');